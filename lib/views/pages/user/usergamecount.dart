...
class UserGameCount extends StatefulWidget {
  final String pUserCode ;
  const UserGameCount({Key? key, required this.pUserCode}) : super(key: key);

  @override
  State<UserGameCount> createState() => _UserSalesRateState();
}

class _UserSalesRateState extends State<UserGameCount> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  gapWC(5),
                  tcn("Game Count", Colors.white, 20)
                ],
              ),
            ),
            gapHC(10),
  ...
  apiUpdateCount(){
    futureForm = apiCall.apiSaveUserGameCount(g.wstrCompany, frSelectedUser, gameCountLimit);
  ...
  apiGetDetails(){
    futureForm  = apiCall.apiGetUserDetails(g.wstrCompany, frSelectedUser, "COUNTLIMIT",g.wstrSelectedGame);
