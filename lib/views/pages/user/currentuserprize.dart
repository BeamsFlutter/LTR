...
class CurrentUserPrize extends StatefulWidget {
  final String pUserCode;
  const CurrentUserPrize({Key? key, required this.pUserCode}) : super(key: key);

  @override
  State<CurrentUserPrize> createState() => _CurrentUserPrizeState();
}

class _CurrentUserPrizeState extends State<CurrentUserPrize> {
