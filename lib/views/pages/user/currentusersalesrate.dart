...
class CurrentUserSalesRate extends StatefulWidget {
  final String pUserCode ;
  const CurrentUserSalesRate({Key? key, required this.pUserCode}) : super(key: key);

  @override
  State<CurrentUserSalesRate> createState() => _CurrentUserSalesRateState();
}

class _CurrentUserSalesRateState extends State<CurrentUserSalesRate> {
  ...
  apiUpdateRate(){
    futureForm = apiCall.apiUpdateUserSaleRate(g.wstrCompany, frSelectedUser, gamePriceList);
