...
class UserSalesRate extends StatefulWidget {
  final String pUserCode ;
  const UserSalesRate({Key? key, required this.pUserCode}) : super(key: key);

  @override
  State<UserSalesRate> createState() => _UserSalesRateState();
}

class _UserSalesRateState extends State<UserSalesRate> {
