...
class GlobalPrize extends StatefulWidget {
  const GlobalPrize({Key? key,}) : super(key: key);

  @override
  State<GlobalPrize> createState() => _GlobalPrizeState();
}

class _GlobalPrizeState extends State<GlobalPrize> {
  ...
  apiUpdatePrize(){
    futureForm = apiCall.apiUpdateGlobalGamePrize(prizeList);
